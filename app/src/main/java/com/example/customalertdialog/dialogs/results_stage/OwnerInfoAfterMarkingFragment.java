...
public class OwnerInfoAfterMarkingFragment extends DialogFragment {
    ...
    public interface DialogListener {
        void showMarkedDeerInfoDialog(int deerNumber);
    }

    public static OwnerInfoAfterMarkingFragment newInstance(String owner, MarkList markList) {
        OwnerInfoAfterMarkingFragment f = new OwnerInfoAfterMarkingFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        cancelButton.setOnClickListener(v -> OwnerInfoAfterMarkingFragment.this.getDialog().cancel());
    ...
    private void addDeersToListView(ArrayList<Integer> deerNumbers, int anId) {
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> listener.showMarkedDeerInfoDialog(
                deerNumbers.get(i))
        );
